...
// GRENADE_EMP_WEAPON_NAME already defined as global const in worldsystems/sh_explosive_loot_hold.nut (same value)
...
#else
void function OnProjectileCollision_weapon_grenade_decoy( entity projectile, vector pos, vector normal, entity hitEnt, int hitbox, bool isCritical, bool isPassthrough )
#endif
{
	entity player = projectile.GetOwner()
	if ( hitEnt == player )
