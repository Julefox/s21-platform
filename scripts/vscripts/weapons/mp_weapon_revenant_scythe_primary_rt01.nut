...
void function MpWeaponRevenantScythePrimary_rt01_Init()
{
	...
	#if SERVER
		AddDamageCallbackSourceID( eDamageSourceId.mp_weapon_revenant_scythe, RevScythe_OnSourceDamage )
		AddDamageCallbackSourceID( eDamageSourceId.melee_revenant_scythe, RevScythe_OnSourceDamage )
	#endif
}
...
#if SERVER
void function RevScythe_OnSourceDamage( entity victim, var damageInfo )
{
