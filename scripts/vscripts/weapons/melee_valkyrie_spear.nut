...
const VALK_FX_ATTACK_SWIPE_TOP_3P = $"P_valk_spear_swipe_3P"   //vfx is currently empty
const VALK_FX_ATTACK_SWIPE_FP = $"P_valk_spear_swipe_FP"
const VALK_FX_ATTACK_SWIPE_3P = $"P_crypto_sword_swipe_3P"        //vfx is currently empty, using rig mesh instead

const VALK_FX_ATTACK_THRUST_FP = $"P_valk_spear_thrust_FP"
const VALK_FX_ATTACK_THRUST_3P = $"P_crypto_sword_swipe_top_3P"   //vfx is currently empty
