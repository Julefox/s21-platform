...
void function PassiveAxiom_EquipReviveShield_Thread( entity reviver, entity target )
{
...

	{
		...
		reviver.SetTrackEntityBlendInTimes( 0.45, 0.15, 0.0 )
		reviver.SetTrackEntityBlendOutTime( 0.25 )
		reviver.SetTrackEntityPitchLookMode( "orbit" )
		reviver.SetTrackEntityYawLookMode( "orbit" )
		reviver.SetTrackEntityDistanceMode( "scriptOffset" )
		reviver.SetTrackEntityMinYaw( -180 )
		reviver.SetTrackEntityMaxYaw( 180 )
		reviver.SetTrackEntityMinPitch( -180 )
		reviver.SetTrackEntityMaxPitch( 180 )
		reviver.SetTrackEntityOffsetDistance( 75.0 )
		reviver.SetTrackEntityOffsetHeight( 15 )
