...
const SEER_FX_ATTACK_SWIPE_3P = $"P_fistblade_swipe_3P"   //vfx is currently empty, using rig mesh instead
const SEER_FX_ATTACK_SWIPE_GLOW_FP = $"P_fistblade_swipe_glow"
const SEER_FX_ATTACK_SWIPE_GLOW_3P = $"P_fistblade_swipe_glow_3P"   //temp to check blade glows
