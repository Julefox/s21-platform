...
// note: called for both "blowoff" and "burnout" states
...
#else
void function OnProjectileCollision_lstar( entity projectile, vector pos, vector normal, entity hitEnt, int hitbox, bool isCritical, bool isPassthrough )
#endif
{
	#if SERVER
