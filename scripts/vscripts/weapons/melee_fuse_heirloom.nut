...
const FUSE_GUITAR_FX_SWIPE_BASE_FP = $"P_fuse_guitar_base" //empty fx
const FUSE_GUITAR_FX_SWIPE_BASE_3P = $"P_fuse_guitar_base_3P"//empty fx
...
void function OnWeaponActivate_melee_fuse_heirloom( entity weapon )
{
	...
	{
		//conditions for crouching and sliding: if one condition is true do not trigger fx. //to remember: IsOnGround,IsSliding,IsCrouched
