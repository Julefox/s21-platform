...
#if CLIENT
void function OnWeaponCustomActivityStart_weapon_rampart_wrench_primary( entity weapon, int sequence )
#else
...
#else
void function OnWeaponCustomActivityEnd_weapon_rampart_wrench_primary( entity weapon )
#endif
{
#if SERVER
