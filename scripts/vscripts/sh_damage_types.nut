...
mp_weapon_pdw_crate
	...
	// S29 loot table weapons
	mp_weapon_mastiff_crate
	mp_weapon_energy_ar_crate
	mp_weapon_doubletake_crate
	mp_weapon_vinson_crate
	mp_weapon_auto_hemlok
	mp_weapon_auto_hemlok_crate
	mp_weapon_g2_crate
	mp_weapon_alternator_smg_crate
	mp_weapon_r97_crate
	mp_weapon_volt_smg_crate
	mp_weapon_dmr_crate
	mp_weapon_defender_crate
	mp_weapon_lmg_crate
	mp_weapon_rspn101_crate
	mp_weapon_energy_shotgun_crate
	mp_weapon_shotgun_pistol_light
	mp_weapon_shotgun_pistol_heavy
	mp_weapon_shotgun_pistol_sniper
	mp_weapon_shotgun_pistol_energy
	mp_weapon_wingman_crate
	mp_weapon_autopistol_fusion
	mp_weapon_autopistol_fusion_crate
	mp_weapon_sentinel_crate
	mp_weapon_bow_crate
	mp_weapon_3030_crate
	mp_weapon_nemesis_crate
	mp_weapon_dragon_lmg_crate
	mp_weapon_car_crate
	mp_weapon_buster_rifle
	mp_weapon_semipistol_crate
	mp_weapon_shotgun_pistol_crate
	mp_weapon_auto_hemlok_breach_charge
	mp_weapon_instagib
	_count
}
...
void function DamageTypes_Init()
{
	...
	file.damageSourceIDToName =
	{
		...
		[ eDamageSourceId.mp_weapon_auto_hemlok_breach_charge ] = "Breach Charge",
	...
	#if DEVELOPER
		//development, with ship builds incase a rare bug happens we dont want to show developer text
