...
{
	// SERVER: GetPlayerArray. CLIENT: GetLocalClientPlayer. Not on UI.
	#if SERVER
...
void function DEV_DrawLineForLowHeightSpawnPoint( entity spawnPoint )
{
	...
	DebugDrawBoxRGB( spawnPoint.GetOrigin(), TRACE_HULL_MIN, TRACE_HULL_MAX, int( SPAWN_DEBUG_COLOR_RED.x ), int( SPAWN_DEBUG_COLOR_RED.y ), int( SPAWN_DEBUG_COLOR_RED.z ), 1, DEBUG_DRAW_DURATION )
}
#endif //SERVER
...
void function DEV_DrawSphereOnBadSpawnPoints( entity spawnPoint )
{
	...
	DebugDrawLineRGB( spawnPoint.GetOrigin(), NavMesh_GetClosestPoint( spawnPoint.GetOrigin() ), int(SPAWN_DEBUG_COLOR_RED.x), int(SPAWN_DEBUG_COLOR_RED.y), int(SPAWN_DEBUG_COLOR_RED.z), true, DEBUG_DRAW_DURATION )
	DebugDrawSphereRGB( spawnPoint.GetOrigin() + DEBUG_BOX_CENTER_OFFSET, DEBUG_SPHERE_RADIUS, int(SPAWN_DEBUG_COLOR_RED.x), int(SPAWN_DEBUG_COLOR_RED.y), int(SPAWN_DEBUG_COLOR_RED.z), true, DEBUG_DRAW_DURATION )
}
#endif // SERVER
#endif // DEV
