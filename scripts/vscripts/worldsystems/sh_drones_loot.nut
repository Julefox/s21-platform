global function ShLootDrones_EntitiesDidLoad
...
global const asset LOOT_DRONE_MODEL = $"mdl/props/loot_drone/loot_drone.rmdl" //$"mdl/robotics_r2/aerial_unmanned_worker/loot_drone.rmdl"
...
// global const float LOOT_DRONE_FALL_TRACE_DIST 			= 1024.0 // Dswieczko, not seeing this used anywhere
...
global const string LOOT_DRONE_NODE_SCRIPT_NAME = "loot_drone_path_node"
...
void function ShLootDrones_EntitiesDidLoad()
{
	#if SERVER || CLIENT
