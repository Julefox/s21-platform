...
void function Dev_SpawnSquadSkyDive_DrawSpawnPoints()
{
	...
	{
		DebugDrawSphereRGB( location.GetOrigin(), 100, int(COLOR_RED.x), int(COLOR_RED.y), int(COLOR_RED.z), true, 20 )
	}
}
#endif
#endif
...
{
	// S21: SPL_GetClosestPosition native. Bridge: clamp via NavMesh_GetClosestPoint.
