...
void function GiveUltBoostByDamageDealt( entity victim )
{
	...
	{
		// S21 used (history.damageType & DF_SHIELD_DAMAGE) != 0; IsBitFlagSet for S21 CLIENT int→bool
		if ( IsBitFlagSet( history.damageType, DF_SHIELD_DAMAGE ) || history.wasBleedingOut )
			continue
