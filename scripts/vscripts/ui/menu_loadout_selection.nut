...
global function LoadoutSelectionMenu_IsLoadoutSelectionAvailable
...
global function LoadoutSelectionMenu_UpdateLoadouts
...
bool function LoadoutSelectionMenu_IsLoadoutSelectionAvailable()
{
	...
	if ( LoadoutSelection_IsFreeroamForceEnabled() || GetCurrentPlaylistVarBool( "freeroam_loadout_menu_enable", false ) )
	{
	...
	if ( GetCurrentPlaylistVarBool( "freedm_ffa_active", false ) || GetCurrentPlaylistVarBool( "freedm_loadout_changeable_at_anytime", false ) )
		return true

	if ( GetGameState() < eGameState.Prematch || GetGameState() > eGameState.WinnerDetermined )
		return false
...
void function LoadoutSelectionMenu_OnLoadoutMenu_Show()
{
	...
	LoadoutSelectionMenu_UpdateLoadouts()
	LoadoutSelectionMenu_ResetLoadoutButtons()
...
void function LoadoutSelectionMenu_RefreshLoadouts( int loadoutSlotType )
{
	...
	LoadoutSelectionMenu_UpdateMaxLoadoutCount( loadoutCount, loadoutSlotType )
...
void function LoadoutSelectionMenu_OpenScopeMenu( var button )
{
	...
	if ( file.loadoutButtons.contains( button ) && CanRunClientScript() )
	{
