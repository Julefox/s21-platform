...
global function CallDLCStoreCallback_Safe
...
{
	// Store lobby tab is unregistered on the bridge client.
	TabData lobbyTabData = GetTabDataForPanel( GetMenu( "LobbyMenu" ) )
	int storeIdx = Tab_GetTabIndexByBodyName( lobbyTabData, "StorePanel" )
	if ( storeIdx < 0 )
		return
	...
	ActivateTab( lobbyTabData, storeIdx )
}
...
string function GetApexPacksPanelName()
{
	string panelName = ""
		...
		panelName = "#MENU_STORE_PANEL_LOOT"
