...
void function SetupSettings()
{
	...
	file.generalSettingsToHud[ eFRSettingType.SHOWDYNTIMER ] <- Hud_GetChild( file.contentPanel, "SwitchDynamicTimer" )
		...
		file.resetButton_DebounceLocked[ "SwitchLegendUpgradesReset" ] <- false
		option = CreateFiringRangeOption( "#FRSETTING_LEGENDUPGRADESRESET", "#FRSETTING_LEGENDUPGRADESRESET_DESC", CRng_LegendUpgradesReset )
		SetUpOptionsButton( Hud_GetChild( file.contentPanel, "SwitchLegendUpgradesReset" ), option )
	...
	file.generalSettingsToHud[ eFRSettingType.FRDUMMIESTRAFEDURATIONMIN ] <- Hud_GetChild( file.contentPanel, "SwitchDummieStrafeDurationMin" )
	file.generalSettingsToHud[ eFRSettingType.FRDUMMIESTRAFEDURATIONMAX ] <- Hud_GetChild( file.contentPanel, "SwitchDummieStrafeDurationMax" )
...
void function UpdateDetails()
{
	...
	Hud_SetEnabled( file.generalSettingsToHud[ eFRSettingType.FRDUMMIESTRAFEDURATIONMIN ], file.isRangeMaster && !fcOn && !file.setting_DebounceLocked[ eFRSettingType.FRDUMMIESTRAFEDURATIONMIN ])
	Hud_SetEnabled( file.generalSettingsToHud[ eFRSettingType.FRDUMMIESTRAFEDURATIONMAX ], file.isRangeMaster && !fcOn && !file.setting_DebounceLocked[ eFRSettingType.FRDUMMIESTRAFEDURATIONMAX ])
...
void function CRng_LegendUpgradesReset( var _ )
{
	string ctrlName = "SwitchLegendUpgradesReset"
	Remote_ServerCallFunction( "UCB_LegendUpgradesReset" )
	thread DebounceLock_ResetButton_Thread( ctrlName )
}
...
void function Firing_Range_GeneralSettingChanged( int setting, var btn )
{
	...
	switch( setting )
	{
		...
		case eFRSettingType.FRDUMMIESTRAFEDURATIONMIN:
			file.generalSettings[ setting ] <- float( indexValue )
			Remote_ServerCallFunction( "UCB_SV_FRSetting_Change_Int", eFRSettingType.FRDUMMIESTRAFEDURATIONMIN, indexValue )
			selectionSwitchID = setting
			break
		case eFRSettingType.FRDUMMIESTRAFEDURATIONMAX:
			file.generalSettings[ setting ] <- float( indexValue )
			Remote_ServerCallFunction( "UCB_SV_FRSetting_Change_Int", eFRSettingType.FRDUMMIESTRAFEDURATIONMAX, indexValue )
			selectionSwitchID = setting
			break
