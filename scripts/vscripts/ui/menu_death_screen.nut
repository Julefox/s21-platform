...
void function InitDeathScreenPanelFooter( var panel, int panelID )
{
	...
	AddPanelFooterOption( panel, RIGHT, KEY_SPACE, true, "#QUIT_SERVER", "#QUIT_SERVER", DeathScreenLeaveGameDialog, DeathScreenShowLobbyButton )
	AddPanelFooterOption( panel, RIGHT, KEY_SPACE, true, "", "#QUIT_SERVER", DeathScreenLeaveGameDialog, DeathScreenShowLobbySpace )
