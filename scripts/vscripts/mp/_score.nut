...
void function ScoreEvent_PlayerKilled( entity player, entity attacker, var damageInfo )
{
	...
	// Duel modes own kill/death netints; skip BR KillPilot/Eliminate spam.
	// Suicide never awards score (legacy Safe_is1v1EnabledAndAllowed).
	if ( FS_HasCap( FS_CAP_DUEL_QUEUE ) )
	{
