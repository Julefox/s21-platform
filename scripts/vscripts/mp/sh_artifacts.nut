...
// Equip-set helper used by DevMenu Alter Loadout (cheats via loadouts_devset, not -dev).
#if UI
...
// Always UI: used by DevMenu loadout equip (requires sv_cheats on server loadouts_devset).
#if UI
