...
void function ClientCodeCallback_MapInit()
{
	...
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_MIRAGE_BOAT", 0.18, 0.53, 0.5 )

	
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_13_LAVA_SIPHON", 0.58, 0.74, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_4_CLIMATIZER", 0.72, 0.19, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_5_LANDSLIDE", 0.36, 0.47, 0.5 )

	
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_8_STAGING", 0.31, 0.59, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_16_LAUNCH_SITE", 0.56, 0.90, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_1_COUNTDOWN", 0.29, 0.36, 0.5 )

	
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_6_MONUMENT", 0.52, 0.40, 0.5 )  
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_6_FRAGMENT", 0.66, 0.44, 0.5 )  
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_3_SURVEY", 0.59, 0.20, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_9_HARVESTER", 0.47, 0.60, 0.5 )

	
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_11_THERMAL_STATION", 0.28, 0.73, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_7_SNOW_FIELD", 0.85, 0.40, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_2_CAP_CITY", 0.35, 0.22, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_15_STACKS", 0.80, 0.80, 0.5 )  
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_5_LAVA_FISSURE", 0.18, 0.43, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_4_GROUND_ZERO", 0.63, 0.30, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_10_RESEARCH_STATION_BRAVO", 0.77, 0.60, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_12_RESEARCH_STATION_ALPHA", 0.41, 0.84, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_16_MT", 0.72, 0.92, 0.5 )

	
	
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_1_BLOOD_SHORT", 0.22, 0.22, 0.5 )
	MapZones_AddMinimapLevelLabel( "#DES_ZONE_15_RAMPART_TT_SHORT", 0.79, 0.71, 0.5 )
}
...
void function Climatizer_FX_Init()
{
	...
	thread Climatizer_FX_MainSequence_Thread()
}
