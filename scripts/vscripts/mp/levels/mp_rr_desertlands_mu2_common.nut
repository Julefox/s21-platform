...
void function RepAnims( entity replicator, entity playerUser )
{
	...
	wait 1
	StartParticleEffectOnEntityWithPos( replicator, GetParticleSystemIndex( $"P_trophy_sys_dmg" ), FX_PATTACH_CUSTOMORIGIN_FOLLOW, ATTACHMENTID_INVALID, <0, 0, 60>, <0, 0, 0> )
