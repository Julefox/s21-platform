	...
	ModeOptionsPanel
    {
        ...
        ContentPanel
        {
            ...
            Switch3rdPerson
            {
                ...
                navDown					SwitchLegendUpgradesEnabled
                list
                {
                    "#SETTING_OFF"	0
                    "#SETTING_ON"	1
            ...
            SwitchLegendUpgradesEnabled
            {
                ...
                navDown					SwitchLegendUpgradesReset
                list
                {
                    "#SETTING_OFF"	0
                    "#SETTING_ON"	1
            ...
            SwitchLegendUpgradesReset
            {
                ControlName				RuiButton
                InheritProperties		SettingBasicButton
                className               "SettingScrollSizer"
                navUp					SwitchLegendUpgradesEnabled
                navDown					SwitchFriendlyFire

                pin_to_sibling			SwitchLegendUpgradesEnabled
                pin_corner_to_sibling	TOP_LEFT
                pin_to_sibling_corner	BOTTOM_LEFT
            }
            SwitchFriendlyFire
            {
                ...
                className               "SettingScrollSizer"
                style					DialogListButton
                navUp					SwitchLegendUpgradesReset
                ...
                pin_to_sibling			SwitchLegendUpgradesReset
                pin_corner_to_sibling	TOP_LEFT
                pin_to_sibling_corner	BOTTOM_LEFT
                childGroupAlways        ChoiceButtonAlways
            }
        ...
        SwitchDummieStrafeDurationMax
        {
	        ...
	        SwitchDummieShooting
            {
                ...
                className               "SettingScrollSizer"
                style					DialogListButton
                navUp					SwitchDummieStrafeDurationMax
                ...
                pin_to_sibling			SwitchDummieStrafeDurationMax
                pin_corner_to_sibling	TOP_LEFT
                pin_to_sibling_corner	BOTTOM_LEFT
                childGroupAlways        MultiChoiceButtonAlways
            }
	        ...
	        SwitchDynDummieSpawn
            {
                ...
                navDown					SwitchDummieHighlights
            ...
            SwitchDummieSpawnDists
            {
                ...
                pin_to_sibling			SwitchDummieHighlights
                pin_corner_to_sibling	TOP_LEFT
                pin_to_sibling_corner	BOTTOM_LEFT
                childGroupAlways        MultiChoiceButtonAlways
            }
