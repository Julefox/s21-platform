...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    SwitchSurvivalSlotToWeaponInspect
    {
        ...
        navDown					SwchAdaptiveTriggers [($PS5 || $PC) && !$NX && !$NX_UI_PC]
        navDown					SwchTriggerDeadzone [!$PS5 && !$PC && !$NX && !$NX_UI_PC]
        navDown					SldCursorVelocity   [!$PS5 && ($NX || $NX_UI_PC)]
    ...
    SwchTriggerDeadzone [!$NX && !$NX_UI_PC]
    {
        ControlName				RuiButton
        InheritProperties		SwitchButton
        className               "SettingScrollSizer"
        style					DialogListButton
        pin_to_sibling			SwitchSurvivalSlotToWeaponInspect [!$PS5 && !$PC]
        pin_to_sibling			SwchAdaptiveTriggers [$PS5 || $PC]
        pin_corner_to_sibling	TOP_LEFT
        pin_to_sibling_corner	BOTTOM_LEFT
        navUp					SwitchSurvivalSlotToWeaponInspect [!$PS5 && !$PC]
        navUp					SwchAdaptiveTriggers [$PS5 || $PC]
    ...
    SwchLookInvert
    {
        ...
        navDown					SwchVibration [!$PS5]
        navDown					SwchVibration_ADTH [$PS5]
        ConVar					"joy_inverty"
        list
        {
            "#SETTING_OFF"			0
    ...
    BtnControllerOpenAdvancedMenu
    {
        ...
        InheritProperties		SettingBasicButton
        className               "SettingScrollSizer"
        pin_to_sibling			SwchVibration [!$PS5]
        pin_to_sibling			SwchVibration_ADTH [$PS5]
        pin_corner_to_sibling	TOP_LEFT
        pin_to_sibling_corner	BOTTOM_LEFT
        navUp					SwchVibration [!$PS5]
        navUp					SwchVibration_ADTH [$PS5]
