...
{	
    ...
    SldADSAdvancedSensitivity6
    {
        ...
        navDown					SldADSAdvancedSensitivity7
    ...
    SldADSAdvancedSensitivity7
    {
        ...
        pin_corner_to_sibling	TOP_LEFT
        pin_to_sibling_corner	BOTTOM_LEFT
        navUp					SldADSAdvancedSensitivity6
        conCommand				"gamepad_ads_advanced_sensitivity_scalar_7"
        minValue				0.2
        maxValue				10.0
        stepSize				0.2
        inverseFill             0
    ...
    TextEntryADSAdvancedSensitivityZoomed7
    {
        ControlName				TextEntry
        InheritProperties       SliderControlTextEntry
        syncedConVar            "gamepad_ads_advanced_sensitivity_scalar_7"
        showConVarAsFloat		1

        pin_to_sibling			SldADSAdvancedSensitivity7
        pin_corner_to_sibling	RIGHT
        pin_to_sibling_corner	RIGHT
    }
} 